...
import { Tabs, Tab } from "@mui/material"; import { useFavourites } from "@/features/hooks/use-favourites";
...
export default function BillsPage() {
    ...
    const displayedRows = showAll ? (legislationData?.results ?? []) : favouriteRows
